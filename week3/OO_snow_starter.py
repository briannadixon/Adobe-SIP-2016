...
class SnowFlake():
    ...
    def __init__(self, size, x_location, y_location, speed):
        self.size= size
    ...
    def falldown(self, speed):
        ...
        pygame.draw.circle(screen,color,[self.x_location, self.y_location],self.size) 
...
while not done:
    ...
    # Begin Snow
    for i in range(100):
        snowflake= SnowFlake(random.randint(2,5), random.randint(0,700), 0, 2)
        snowflake.falldown(random.randint(2,4))
